...
const CACHE_NAME = 'offline-code-reader-v10';
const APP_FILES = [
  './', './index.html', './styles.css', './app.js', './serial.js', './recognition.js', './photo-files.js', './manifest.webmanifest', './icon.svg',
  './vendor/tesseract/tesseract.min.js', './vendor/tesseract/worker.min.js', './vendor/lang-data/eng.traineddata.gz', './vendor/lang-data/jpn.traineddata.gz',
